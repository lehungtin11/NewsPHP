<?php 
    ...
    $query2 = "SELECT * FROM tbl_baiviet WHERE tbl_baiviet.id_danhmuc=29 ORDER BY id_baiviet ASC LIMIT 1";
    $render2 = mysqli_query($mysqli, $query2);
    $query3 = "SELECT * FROM tbl_baiviet WHERE tbl_baiviet.id_danhmuc=29 ORDER BY id_baiviet DESC";
    $render3 = mysqli_query($mysqli, $query3);
    $query4 = "SELECT * FROM tbl_baiviet WHERE tbl_baiviet.id_danhmuc=29 ORDER BY id_baiviet DESC LIMIT 1";
    $render4 = mysqli_query($mysqli, $query4);
?>
<div class="row">
                <h2 class="news"> Tin Tức</h2>
            </div>
            <div class="row">
                <div class="col-9 ">
                    ...
                    <?php while($row = mysqli_fetch_array($render4)){ ?>
                        ...
                        <div class="news-content col-4">
                            <a href="index.php?quanly=tintuc&id=<?php echo $row['id_baiviet'] ?>" class="head-content">
                    ...
                    <div class="news-right">
                        ...
                        <?php while($row = mysqli_fetch_array($render2)){ ?>
                            ...
                            <div class="news-content">
                                <a href="index.php?quanly=tintuc&id=<?php echo $row['id_baiviet'] ?>" class="head-content head-content__right">
            ...
            <div class="grid">
                <div class="row">
                    <div class="news-middle">
                        ...
                        <div class="col-3">
                            <div class="news-mid">
                                <a href="index.php?quanly=tintuc&id=<?php echo $row['id_baiviet'] ?>">
                                    <div class="height" style="height:100%">
                                        <img class="news-mid__img" src="admin/modules/quanlybv/uploads/<?php echo $row['hinhanh']?>" alt="">
                                    </div>
                                </a>
                                <a href="index.php?quanly=tintuc&id=<?php echo $row['id_baiviet'] ?>" class="news-mid__item-head">
                                    <?php echo $row['tenbaiviet']?>
                                </a>
                                <span style="color: #868482; font-size: 1.4rem;">
                                <?php echo $row['ngay']?>
